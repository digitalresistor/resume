...
\email{delta@regeer.org}                               % optional, remove / comment the line if not wanted
\homepage{deltaregeer.com}                         % optional, remove / comment the line if not wanted
\social[linkedin]{deltaregeer}                        % optional, remove / comment the line if not wanted
\social[github]{digitalresistor}                              % optional, remove / comment the line if not wanted
